# Generated by Django 4.2.20 on 2025-03-19 12:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referals', models.ManyToManyField(related_name='invites', to='app2.account')),
            ],
        ),
        migrations.CreateModel(
            name='Blog',
            fields=[
                ...
                ('account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app2.account')),
            ],
        ),
        migrations.AddField(
            model_name='account',
            name='plan',
            field=models.ManyToManyField(blank=True, related_name='subscription', to='app2.plan'),
        ),
        migrations.AddField(
            model_name='account',
            name='user',
